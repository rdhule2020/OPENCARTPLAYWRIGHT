    ...
    - generic [ref=e160]:
      - generic [ref=e162]:
        ...
        - generic:
          - img "Nintendo"
        - img "NFL" [ref=e176]
        - img "RedBull" [ref=e178]
        - img "Sony" [ref=e180]
        - img "Coca Cola" [ref=e182]
        - img "Burger King" [ref=e184]
      - generic:
      ...
      - generic [ref=e201]:
        ...
        - generic [ref=e222]:
          ...
          - list [ref=e224]:
            ...
            - listitem [ref=e227]:
              - link "Gift Certificates" [ref=e228] [cursor=pointer]:
                - /url: https://tutorialsninja.com/demo/index.php?route=account/voucher
            - listitem [ref=e229]:
              - link "Affiliate" [ref=e230] [cursor=pointer]:
                - /url: https://tutorialsninja.com/demo/index.php?route=affiliate/login
            - listitem [ref=e231]:
              - link "Specials" [ref=e232] [cursor=pointer]:
                - /url: https://tutorialsninja.com/demo/index.php?route=product/special
        - generic [ref=e233]:
          - heading "My Account" [level=5] [ref=e234]
          - list [ref=e235]:
            - listitem [ref=e236]:
              - link "My Account" [ref=e237] [cursor=pointer]:
                - /url: https://tutorialsninja.com/demo/index.php?route=account/account
            - listitem [ref=e238]:
              - link "Order History" [ref=e239] [cursor=pointer]:
                - /url: https://tutorialsninja.com/demo/index.php?route=account/order
            - listitem [ref=e240]:
              - link "Wish List" [ref=e241] [cursor=pointer]:
                - /url: https://tutorialsninja.com/demo/index.php?route=account/wishlist
            - listitem [ref=e242]:
              - link "Newsletter" [ref=e243] [cursor=pointer]:
                - /url: https://tutorialsninja.com/demo/index.php?route=account/newsletter
      - separator [ref=e244]
      - paragraph [ref=e245]:
        - text: Powered By
        - link "OpenCart" [ref=e246] [cursor=pointer]:
...
> 33 |             expect(isLoggedIn).toBeTruthy();
  ...
  43 | }
  44 | 
  45 | //Load CSV test data logindata.json
  46 | 
  ...
  52 | {
  53 |    test(`Login Test with CSV Data: "${data.testName}" @datadriven`, async({page})=>{
  54 | 
  55 |         const config = new TestConfig(); // create instance
  56 |         await page.goto(config.appUrl);    // getting appURL from test.config.ts file
  57 | 
  ...
  66 |         {
  67 |             const myAccountPage=new MyAccountPage(page);
  68 |             const isLoggedIn=await myAccountPage.isMyAccountPageExists();
  69 |             expect(isLoggedIn).toBeTruthy();
  70 | 
  71 |         }
  72 |         else{
  73 |             const errorMessage=await loginPage.getLoginErrorMessage();
  74 |             //expect(errorMessage).toBe('Warning: No match for E-Mail Address and/or Password.');
  75 |             expect(errorMessage).toContain('Warning: No match');    
  76 |         }
  77 |     })
  78 | 
  79 | }
